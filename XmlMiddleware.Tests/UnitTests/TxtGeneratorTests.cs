...
public class TxtGeneratorTests
{
    private readonly TxtGenerator _generator;

    public TxtGeneratorTests()
    {
        _generator = new TxtGenerator();
    }
    ...
    public void Generate_ShouldContainUnitPrice()
    {
        ...
        // Assert
        content.Should().Contain("Unit Price     : 750.00");
    }

    [Fact]
    public void Generate_ShouldContainOrderHeader()
    {
        // Arrange
        var orders = CreateOrders();
    ...
    [Fact]
    public void Generate_ShouldGenerateMultipleOrders()
    {
        // Arrange
        var orders =
    ...
    [Fact]
    public void Generate_ShouldHandleEmptyOrderCollection()
    {
        // Arrange
        var orders =
            new List<CanonicalOrderModel>();
